...
//        }
        ...
        mUserToDoItem = (ToDoItem)getIntent().getSerializableExtra(SettingActivity.TODOITEM);
...
//        if(theme.equals(SettingActivity.DARKTHEME)){
...
//            mTimeEditText.setText(timeOption);
    ...
    private String getThemeSet(){
        return getSharedPreferences(SettingActivity.THEME_PREFERENCES, MODE_PRIVATE).getString(SettingActivity.THEME_SAVED, SettingActivity.LIGHTTHEME);
    }
...
//        mUserToDoItem.setLastEdited(mLastEdited);
        ...
        i.putExtra(SettingActivity.TODOITEM, mUserToDoItem);
        setResult(result, i);
    }
